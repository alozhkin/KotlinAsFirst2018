...
class Tests {
    ...
    fun segmentLength() {
        ...
        assertEquals(0, segmentLength(8, 12, 12, 12))
        assertEquals(3, segmentLength(8, 12, 9, 12))
        assertEquals(4, segmentLength(8, 13, 8, 12))
        assertEquals(0, segmentLength(8, 8, 2, 12))
        assertEquals(0, segmentLength(8, 13, 12, 12))
