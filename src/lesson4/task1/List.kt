...
fun russian(n: Int): String {
    ...
    if (n / 1000 % 100 in 10 .. 19) {
        when (n / 1000 % 10) {
            0 -> list += " десять тысяч"
            1 -> list += " одиннадцать тысяч"
            2 -> list += " двенадцать тысяч"
            3 -> list += " тринадцать тысяч"
            4 -> list += " четырнадцать тысяч"
            5 -> list += " пятнадцать тысяч"
            6 -> list += " шестнадцать тысяч"
            7 -> list += " семнадцать тысяч"
            8 -> list += " восемнадцать тысяч"
            9 -> list += " девятнадцать тысяч"
        }
    } else if (n / 1000 != 0){
        when (n / 10000 % 10) {
            2 -> list += " двадцать"
